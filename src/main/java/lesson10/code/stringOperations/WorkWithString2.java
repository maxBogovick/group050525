...
public class WorkWithString2 {
    public static void main(String[] args) {
        ...
        /*
        в строке каждый символ имеет свой порядковый номер
        нумерация символов в строке начинается с 0

        ПОЭТОМУ если в строке 10 символов (length() = 10)
        то индексы будут принимать значение от 0 до 9
         */
        ...
        String substringFromText1 = text.substring(29);

        String substringFromText2 = text.substring(0, 15);

        System.out.println(substringFromText1);
        System.out.println(substringFromText2);
